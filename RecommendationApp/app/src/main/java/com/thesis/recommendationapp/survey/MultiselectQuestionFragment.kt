...
//        }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        nextButton.setOnClickListener {
            findNavController().navigate(R.id.action_multiselectQuestionFragment_to_resultFragment)
        }
    ...
    companion object {
         ...
         * @return A new instance of fragment MultiselectQuestionFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            MultiselectQuestionFragment().apply {
